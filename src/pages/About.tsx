...
const About = () => (
  <section className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-4 sm:px-6 py-16 sm:py-24 relative">
    ...
    <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold mb-4 sm:mb-6 text-center">About Endustry Plant</h1>
    <p className="max-w-xl sm:max-w-2xl text-base sm:text-lg md:text-xl text-center text-gray-600 dark:text-gray-300 font-medium">
      Endustry Plant is an elite product & AI automation agency. We help founders, startups, and teams build, launch, and scale world-class digital products, SaaS, and automation systems—fast.
    </p>
  </section>
);
